...
const (
	...
	EmployeeService_SetEmployeeActive_FullMethodName         = "/employee.v1.EmployeeService/SetEmployeeActive"
	EmployeeService_UpdateEmployeePermissions_FullMethodName = "/employee.v1.EmployeeService/UpdateEmployeePermissions"
	EmployeeService_GetAllPermissions_FullMethodName         = "/employee.v1.EmployeeService/GetAllPermissions"
)
...
type EmployeeServiceClient interface {
	...
	SetEmployeeActive(ctx context.Context, in *SetEmployeeActiveRequest, opts ...grpc.CallOption) (*SetEmployeeActiveResponse, error)
	// Replace all permissions for an employee
	UpdateEmployeePermissions(ctx context.Context, in *UpdateEmployeePermissionsRequest, opts ...grpc.CallOption) (*UpdateEmployeePermissionsResponse, error)
...
func (c *employeeServiceClient) SetEmployeeActive(ctx context.Context, in *SetEmployeeActiveRequest, opts ...grpc.CallOption) (*SetEmployeeActiveResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetEmployeeActiveResponse)
	err := c.cc.Invoke(ctx, EmployeeService_SetEmployeeActive_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *employeeServiceClient) UpdateEmployeePermissions(ctx context.Context, in *UpdateEmployeePermissionsRequest, opts ...grpc.CallOption) (*UpdateEmployeePermissionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateEmployeePermissionsResponse)
	err := c.cc.Invoke(ctx, EmployeeService_UpdateEmployeePermissions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *employeeServiceClient) GetAllPermissions(ctx context.Context, in *GetAllPermissionsRequest, opts ...grpc.CallOption) (*GetAllPermissionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllPermissionsResponse)
	err := c.cc.Invoke(ctx, EmployeeService_GetAllPermissions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmployeeServiceServer interface {
	...
	// Toggle active/inactive status
	SetEmployeeActive(context.Context, *SetEmployeeActiveRequest) (*SetEmployeeActiveResponse, error)
	// Replace all permissions for an employee
	UpdateEmployeePermissions(context.Context, *UpdateEmployeePermissionsRequest) (*UpdateEmployeePermissionsResponse, error)
	// List all available system permissions
...
func (UnimplementedEmployeeServiceServer) SetEmployeeActive(context.Context, *SetEmployeeActiveRequest) (*SetEmployeeActiveResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetEmployeeActive not implemented")
}
func (UnimplementedEmployeeServiceServer) UpdateEmployeePermissions(context.Context, *UpdateEmployeePermissionsRequest) (*UpdateEmployeePermissionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateEmployeePermissions not implemented")
}
func (UnimplementedEmployeeServiceServer) GetAllPermissions(context.Context, *GetAllPermissionsRequest) (*GetAllPermissionsResponse, error) {
...
func _EmployeeService_SetEmployeeActive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetEmployeeActiveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EmployeeServiceServer).SetEmployeeActive(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmployeeService_SetEmployeeActive_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServiceServer).SetEmployeeActive(ctx, req.(*SetEmployeeActiveRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EmployeeService_UpdateEmployeePermissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateEmployeePermissionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EmployeeServiceServer).UpdateEmployeePermissions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmployeeService_UpdateEmployeePermissions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServiceServer).UpdateEmployeePermissions(ctx, req.(*UpdateEmployeePermissionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EmployeeService_GetAllPermissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAllPermissionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EmployeeServiceServer).GetAllPermissions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmployeeService_GetAllPermissions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmployeeServiceServer).GetAllPermissions(ctx, req.(*GetAllPermissionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EmployeeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _EmployeeService_SetEmployeeActive_Handler,
		},
		{
			MethodName: "UpdateEmployeePermissions",
			Handler:    _EmployeeService_UpdateEmployeePermissions_Handler,
		},
		{
			MethodName: "GetAllPermissions",
			Handler:    _EmployeeService_GetAllPermissions_Handler,
		},
	},
