...
func (x *LoginResponse) GetEmployee() *EmployeeInfo {
	if x != nil {
		return x.Employee
	}
	return nil
...
type EmployeeInfo struct {
	...
	Pozicija      string                 `protobuf:"bytes,6,opt,name=pozicija,proto3" json:"pozicija,omitempty"`
...
func (x *EmployeeInfo) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *EmployeeInfo) GetIme() string {
	if x != nil {
		return x.Ime
	}
	return ""
...
func (x *EmployeeInfo) GetPrezime() string {
	if x != nil {
		return x.Prezime
	}
	return ""
...
func (x *EmployeeInfo) GetPozicija() string {
	if x != nil {
		return x.Pozicija
	}
	return ""
...
func (x *EmployeeInfo) GetPermissions() []string {
	if x != nil {
...
func (x *ActivateAccountRequest) GetPasswordConfirm() string {
	if x != nil {
...
const file_proto_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x18proto/auth/v1/auth.proto\x12\aauth.v1\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"@\n" +
	...
	"\bemployee\x18\x03 \x01(\v2\x15.auth.v1.EmployeeInfoR\bemployee\"\xba\x01\n" +
	...
	"\bpozicija\x18\x06 \x01(\tR\bpozicija\x12 \n" +
	...
	"\x10password_confirm\x18\x03 \x01(\tR\x0fpasswordConfirm\"M\n" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12)\n" +
	"\x10password_confirm\x18\x03 \x01(\tR\x0fpasswordConfirm\"K\n" +
	...
	"\fRefreshToken\x12\x1c.auth.v1.RefreshTokenRequest\x1a\x1d.auth.v1.RefreshTokenResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/api/v1/auth/refresh\x12v\n" +
	"\x0fActivateAccount\x12\x1f.auth.v1.ActivateAccountRequest\x1a .auth.v1.ActivateAccountResponse\" \x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/api/v1/auth/activate\x12\x93\x01\n" +
	...
	"\rResetPassword\x12\x1d.auth.v1.ResetPasswordRequest\x1a\x1e.auth.v1.ResetPasswordResponse\".\x82\xd3\xe4\x93\x02(:\x01*\"#/api/v1/auth/password-reset/confirmB\xd3\x01\x92A\x85\x01\x12M\n" +
	"\x15Bank App — Auth API\x12/Authentication and account management endpoints2\x031.0Z4\n" +
	"2\n" +
	"\x06Bearer\x12(\b\x02\x12\x13Enter: Bearer <JWT>\x1a\rAuthorization \x02ZHgithub.com/RAF-SI-2025/EXBanka-3-Infrastructure/gen/proto/auth/v1;authv1b\x06proto3"
...
var file_proto_auth_v1_auth_proto_goTypes = []any{
	...
	(*EmployeeInfo)(nil),                 // 2: auth.v1.EmployeeInfo
	(*RefreshTokenRequest)(nil),          // 3: auth.v1.RefreshTokenRequest
	(*RefreshTokenResponse)(nil),         // 4: auth.v1.RefreshTokenResponse
	(*ActivateAccountRequest)(nil),       // 5: auth.v1.ActivateAccountRequest
	(*ActivateAccountResponse)(nil),      // 6: auth.v1.ActivateAccountResponse
...
var file_proto_auth_v1_auth_proto_depIdxs = []int32{
	2,  // 0: auth.v1.LoginResponse.employee:type_name -> auth.v1.EmployeeInfo
	...
	5,  // 3: auth.v1.AuthService.ActivateAccount:input_type -> auth.v1.ActivateAccountRequest
	7,  // 4: auth.v1.AuthService.RequestPasswordReset:input_type -> auth.v1.RequestPasswordResetRequest
	9,  // 5: auth.v1.AuthService.ResetPassword:input_type -> auth.v1.ResetPasswordRequest
	1,  // 6: auth.v1.AuthService.Login:output_type -> auth.v1.LoginResponse
	4,  // 7: auth.v1.AuthService.RefreshToken:output_type -> auth.v1.RefreshTokenResponse
	6,  // 8: auth.v1.AuthService.ActivateAccount:output_type -> auth.v1.ActivateAccountResponse
	8,  // 9: auth.v1.AuthService.RequestPasswordReset:output_type -> auth.v1.RequestPasswordResetResponse
	10, // 10: auth.v1.AuthService.ResetPassword:output_type -> auth.v1.ResetPasswordResponse
